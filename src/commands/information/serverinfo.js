  ...
  async exec(message) {
    ...
    const embed = new MessageEmbed()
      ...
      .addField("__General Information__", [
        ...
        `**❯ Time Created:** ${moment(message.guild.createdTimestamp).format("LT")} ${moment(message.guild.createdTimestamp).format(
          "LL"
      ...
      .addField("__Highlights__", [
        `**❯ Boosts:** ${message.guild.premiumTier ? `Level ${message.guild.premiumTier}` : "Level 0"} with ${
